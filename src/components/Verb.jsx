...
export default function Verb({ verb, isChecking }) {
    ...
    return (
        <tr>
            ...
            <VerbInput string={verb.thirdPerson} isShown={randomNumberBetween1And5 === 2} isChecking={isChecking} />
            <VerbInput string={verb.simplePast} isShown={randomNumberBetween1And5 === 3} isChecking={isChecking} />
            <VerbInput string={verb.pastPerfect} isShown={randomNumberBetween1And5 === 4} isChecking={isChecking} />
